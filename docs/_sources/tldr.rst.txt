...
As indicated in the console output there is now a project at ``C:\Users\sburke\PycharmProjects\py_project``.
I suggest using PyCharm to open it and get coding.
